          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center">
              ...
              <div className="ml-2 lg:ml-0">
                ...
                <p className="text-xs text-gray-500 font-medium">Atacado para Lojistas</p>
              </div>
            </div>
            ...
            <div className="flex-1 max-w-lg mx-4">
              <div className="relative">
                <input
                  type="text"
                  placeholder="🔍 Buscar produtos, capinhas, películas..."
                  value={searchTerm}
                  onChange={(e) => setSearchTerm(e.target.value)}
                  className="w-full px-4 py-3 pl-12 pr-4 text-gray-700 bg-white/70 backdrop-blur border-2 border-gray-200 rounded-xl focus:outline-none focus:border-orange-400 focus:bg-white transition-all shadow-sm"
                />
